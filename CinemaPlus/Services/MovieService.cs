...
namespace CinemaPlus.Services
{
    public class MovieService
    {
        ...
        public static List<Movie> GetMoviesBySearch(string movie, bool returnOneMovie = false)
        {
            ...
            response = httpClient.GetAsync($@"http://www.omdbapi.com/?apikey=3b5c7291&s={movie}&plot=full").Result;
            ...
            if (Data.Response == "True")
            {
                ...
                {
                    response = httpClient.GetAsync($@"http://www.omdbapi.com/?apikey=3b5c7291&t={Data.Search[i].Title}&plot=full").Result;
